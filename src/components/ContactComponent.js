...
class Contact extends Component {
  ...
  validate(firstname, lastname, telnum,email){
    ...
    if(this.state.touched.firstname && firstname.length <3){
      errors.firstname = "First Name should be greater than or equal 3 characters";
    }
    ...
    if(this.state.touched.emaill && email.split('').filter(x=>x==='@').length !==1){
                  ...
                  <FormGroup check>
                    <Label check>
                      <Input
                        type="checkbox"
                        name="agree"
                        check={this.state.agree} onChange={this.handleInputChange}
                      />{" "}
